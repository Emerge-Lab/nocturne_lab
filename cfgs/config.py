...
PROCESSED_TRAIN_NO_TL = os.path.join(DATA_FOLDER, f"formatted_json_v{VERSION_NUMBER}_no_tl_train")
PROCESSED_VALID_NO_TL = os.path.join(DATA_FOLDER, f"formatted_json_v{VERSION_NUMBER}_no_tl_valid")
